...
use libafl_qemu::{
    edges::edges_map_mut_slice, edges::QemuEdgeCoverageHelper,
    edges::MAX_EDGES_NUM, elf::EasyElf, filter_qemu_args,
    hooks::QemuHooks, snapshot::QemuSnapshotHelper, Emulator, GuestReg, MmapPerms, QemuExecutor,
    Regs,
};
...
pub fn main() {
    ...
    fuzz(out_dir, crashes, in_dir, tokens, timeout)
