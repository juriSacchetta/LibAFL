...
use libafl_qemu::{
    asan::{init_with_asan, QemuAsanHelper}, cmplog::QemuCmpLogHelper, edges::QemuEdgeCoverageHelper, elf::EasyElf, fibers::input::QemuFibersInput, ArchExtras, Emulator, GuestAddr, QemuInstrumentationAddressRangeFilter
};
...
use libafl_qemu::fibers::QemuFibersSchedulerHelper;
use libafl_qemu::snapshot::QemuSnapshotHelper;
...
impl<'a> Client<'a> {
    ...
    pub fn run<M: Monitor>(
        ...
        let injection_helper: Option<()> = None;
        ...
        let instance = Instance::builder()
            ...
            .emu(&emu)
            .mgr(mgr)
            .core_id(core_id).extra_tokens(extra_tokens);
